...
const BookingSection = () => {
  return (
    <div className ="bg-gray-100 min-h-screen flex flex-col items-center justify-center overflow-hidden my-[-5px]" style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="flex flex-col w-2/5 mr-auto ml-20">
      <div className="text-center mb-8 ">
        <h1 className="text-4xl font-bold text-left text-white">Congratulation! You&apos;re already ahead of 16 crore People</h1>
      </div>
      <div className="mb-8">
